...
from utils.general import top_p_sampling
...
class CausalSelfAttention(AttentionBase):
    ...
    def __init__(self,
        ...
        super().__init__(bias, block_size, dropout, n_embd, n_head)
...
class CrossAttention(AttentionBase):
    ...
    def __init__(
        ...
        super().__init__(bias, block_size, dropout, n_embd, n_head)
        self.ckv_attn = nn.Linear(n_embd, 2 * n_embd, bias=bias)
        self.cq_attn = nn.Linear(n_embd, n_embd, bias=bias)
...
class MLP(nn.Module):
    ...
    def __init__(self, bias: bool, dropout: float, n_embd: int):
        super().__init__()
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.attn = CausalSelfAttention(bias, block_size, dropout, n_embd, n_head)
        self.ln_2 = LayerNorm(n_embd, bias=bias)
        self.mlp = MLP(bias, dropout, n_embd)
